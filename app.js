...
var budgetCotroller = (function(){
    ...
    return {
        addItem: function(type, des, val){
            ...
            //Create new item basen on 'inc' or 'exp'
            if(type === 'exp'){
        ...
        calculateBudget: function(){
            ...
            //Calculate % of income and expenses
...
var UIController = (function(){
    ...
    return {
        ...
        clearFields: function(){
            ...
            //Systax here, is like css selecting.
            fieldsList = document.querySelectorAll(DOMStrings.inputDescription + ', ' +  DOMStrings.inputValue);
            
            fieldsList.forEach(function(current, index, array){
                current.value = "";
            });

            //Set description on focus
            fieldsList[0].focus();
        ...
        displayPercentages: function(percentages){
            ...
            //Node List = html element's
            var fields = document.querySelectorAll(DOMStrings.expensesPercLabel);

            //Loop all over these elements/nodes in our selection, to change the textContent.
...
var controller = (function(budgetCtrl, UICtrl){
    ...
    var updatePercentages = function(){
        ...
        // Update the UI with the new percenetages
